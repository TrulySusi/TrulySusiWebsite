  ...
  return (
    <div className="mb-5 flex flex-wrap items-center gap-3">
      <input
        ...
        className="w-full max-w-xs rounded-lg border border-navy/15 bg-white px-3.5 py-2 font-body text-sm text-navy placeholder:text-navy/40 focus:outline-none focus:ring-1 focus:ring-navy/20"
      />
